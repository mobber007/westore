<template>
  <v-btn icon transition="scale-transition" v-if="favorited" @click.prevent="unfavorite(product.id)">
    <v-icon color="error">favorite</v-icon>
  </v-btn>
  <v-btn icon transition="scale-transition" v-else="" @click.prevent="favorite(product.id)">
